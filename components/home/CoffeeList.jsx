      ...
      >
        ...
        >
          ...
          <Typography
            ...
            sx={{
              textAlign: "center",
              padding: { xs: "0 20px", sm: "20px 20px" },
              fontSize: { xs: "14px", sm: "18px" },
              color: "gray",
            }}
          >
            Coffify is a specialty coffee shop that delivers fresh,
            great-tasting coffee right to you. We offer the freshest, most
            aromatic smelling coffee at a fraction of what you’ve been paying.
          </Typography>
        </Grid>
        <Grid direction="column" item lg={3} md={3} sm={12} sx={{}}></Grid>
      </Grid>
